...
class ImagePickerScreen extends StatelessWidget {
          ...
          child: Column(
            children: [
              ...
              if (platformProvider.selectedImage != null) ...[
                _buildSelectedImageCard(context, platformProvider),
              ] else ...[
                _buildImagePlaceholderCard(context, platformProvider),
              ],

              // Error Card
              if (platformProvider.error != null) ...[
                const SizedBox(height: 20),
                _buildErrorCard(context, platformProvider),
              ],

              const SizedBox(height: 20),

              // Space for battery overlay
            ],
          ),
        );
      },
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 12),
                ElevatedButton.icon(
                  onPressed: () => platformProvider.clearSelectedImage(),
  ...
  Widget _buildErrorCard(BuildContext context, dynamic platformProvider) {
    return Card(
      child: Container(
        padding: const EdgeInsets.all(20),
        decoration: BoxDecoration(
